  ...
  return (
    <section className="mb-12">
      ...
      <div className="my-12">
        ...
        >
          {reviews.map(reveiw => (
            <SwiperSlide key={reveiw._id}>
              <div className="m-12 space-y-5 text-center">
                <Rating
                  placeholderRating={reveiw.rating}
                  placeholderSymbol={
                    <FaStar className="text-yellow-500 text-3xl"></FaStar>
                  }
                  emptySymbol={<FaRegStar className="text-3xl"></FaRegStar>}
                  fullSymbol={
                    <FaStar className="text-yellow-500 text-3xl"></FaStar>
                  }
                />
                ...
                <p className="font-[Inter] lg:w-10/12 mx-auto">
                  {reveiw.details}
                </p>
                <h3 className="text-[#CD9003] text-3xl uppercase">
                  {reveiw.name}
                </h3>
              </div>
            </SwiperSlide>
